...
namespace QuantaForge\Redis;

use Closure;
use QuantaForge\Contracts\Redis\Factory;
use QuantaForge\Redis\Connections\Connection;
use QuantaForge\Redis\Connectors\PhpRedisConnector;
use QuantaForge\Redis\Connectors\PredisConnector;
use QuantaForge\Support\Arr;
use QuantaForge\Support\ConfigurationUrlParser;
use InvalidArgumentException;

/**
 * @mixin \QuantaForge\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @param  \QuantaForge\Redis\Connections\Connection  $connection
     * @param  string  $name
     * @return \QuantaForge\Redis\Connections\Connection
     */
     ...
     *
     * @return \QuantaForge\Contracts\Redis\Connector|null
     */
