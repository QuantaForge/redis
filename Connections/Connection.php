...
namespace QuantaForge\Redis\Connections;

use Closure;
use QuantaForge\Contracts\Events\Dispatcher;
use QuantaForge\Redis\Events\CommandExecuted;
use QuantaForge\Redis\Limiters\ConcurrencyLimiterBuilder;
use QuantaForge\Redis\Limiters\DurationLimiterBuilder;
...
abstract class Connection
{
     ...
     *
     * @param  string  $name
     * @return \QuantaForge\Redis\Limiters\ConcurrencyLimiterBuilder
     */
     ...
     *
     * @param  string  $name
     * @return \QuantaForge\Redis\Limiters\DurationLimiterBuilder
     */
