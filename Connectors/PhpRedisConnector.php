...
namespace QuantaForge\Redis\Connectors;

use QuantaForge\Contracts\Redis\Connector;
use QuantaForge\Redis\Connections\PhpRedisClusterConnection;
use QuantaForge\Redis\Connections\PhpRedisConnection;
use QuantaForge\Support\Arr;
use QuantaForge\Support\Facades\Redis as RedisFacade;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param  array  $config
     * @param  array  $options
     * @return \QuantaForge\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param  array  $options
     * @return \QuantaForge\Redis\Connections\PhpRedisClusterConnection
     */
